...
export const HorarioTableNoModificaciones = ({eventos=[]}) => {
  ...
  const [modalStates, setModalStates] = useState({}); // Estado para controlar los modales individuales

  // const handleTextClicDetalle = (id) => {
  //   setModalStates((prevState) => ({
  //     ...prevState,
  //     [id]: true, // Establece el estado del modal correspondiente al ID del evento en true
  //   }));
  // };
    const handleTextClicDetalle = (id) => {
    ...
    //   setModalStates((prevState) => ({
    //     ...prevState,
    //     [id]: false, // Establece el estado del modal correspondiente al ID del evento en false
    //   }));
    // };
